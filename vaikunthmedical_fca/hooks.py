...
doctype_js = {
	"Purchase Receipt": "public/js/scm.js",
	"Purchase Invoice": "public/js/scm.js",
}
...
doc_events = {
	...
	"Purchase Receipt": {
		"before_validate": [
			...
			"vaikunthmedical_fca.scm.neutralize_discount_percentage",
		],
		"validate": [
			"vaikunthmedical_fca.purchase_receipt.ensure_batch_with_expiry",
			"vaikunthmedical_fca.scm.apply_scm_and_discount_to_amount",
	...
	"Purchase Invoice": {
		"before_validate": "vaikunthmedical_fca.scm.neutralize_discount_percentage",
		"validate": [
			"vaikunthmedical_fca.scm.apply_scm_and_discount_to_amount",
			"vaikunthmedical_fca.scm.set_total_scm_amount",
		],
